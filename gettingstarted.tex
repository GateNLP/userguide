...
Proxy configuration (see Section~\ref{sec:misc-creole:proxy}) can be set in
this file -- by default GATE uses the system-wide proxy settings
(\verb!-Djava.net.useSystemProxies=true!) but a specific proxy can be
configured by deleting that line and replacing it with settings such as:
%
\begin{verbatim}
