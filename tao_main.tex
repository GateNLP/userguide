...
\ifgaterelease\else%
  \ifhtml
    \fcolorbox{red}{white}{\begin{minipage}{0.9\textwidth}
      ...
      \htlink{https://gate.ac.uk/userguide?gateVersion=8.4.1}{version 8.4.1}
      \end{center}
    \end{minipage}}
  \fi
\fi
...
\textbf{\copyright 2017 The University of Sheffield, Department of Computer Science}
