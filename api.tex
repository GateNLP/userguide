...
the JavaDocs for \texttt{\htlink{https://jenkins.gate.ac.uk/job/gate-components/job/gate-spring/job/master/javadoc/index.html}{the gate-spring module}}.
...
As discussed in Section \ref{sec:api:bootstrap} GATE provides a Maven \emp{archetype}
