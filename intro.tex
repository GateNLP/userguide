...
\item \htlink{http://gate.ac.uk/gate/doc/javadoc}{JavaDoc API
documentation};

\item \htlink{http://gate.ac.uk/gate/doc/java2html}{HTML of the
source code};

\item \htlink{http://gate.ac.uk/gate/doc/plugins.html}{comprehensive list of GATE plugins}.
\end{itemize}
